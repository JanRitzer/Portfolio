...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "projects.portfolio.description": "My personal developer portfolio featuring a modern dark UI with 3D tilt effects, gyroscope-based mobile interactions, bilingual support (EN/DE), and smooth scroll animations. Built as a single-page app deployed on Vercel with a serverless contact form powered by Resend.",
    ...
    "experience.elunic.location": "Munich",
    ...
    "contact.cta.desc": "I'm currently available for freelance work. Whether you need an iOS app, a web platform, or AI integration, I'm here to help bring your vision to life.",
  ...
  de: {
    ...
    "projects.portfolio.description": "Mein persönliches Entwickler-Portfolio mit modernem Dark UI, 3D-Tilt-Effekten, gyroskopbasierten mobilen Interaktionen, zweisprachiger Unterstützung (EN/DE) und flüssigen Scroll-Animationen. Gebaut als Single-Page-App, deployed auf Vercel mit einem serverlosen Kontaktformular über Resend.",
    ...
    "experience.elunic.location": "München",
    "experience.dataAnnotation.title": "Generative AI Engineer",
    ...
    "contact.cta.desc": "Ich bin derzeit verfügbar für Freelance-Arbeit. Ob iOS-App, Web-Plattform oder KI-Integration – ich helfe gerne, Ihre Vision zu verwirklichen.",
