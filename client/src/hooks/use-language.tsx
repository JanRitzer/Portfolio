...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "experience.selfEmployed.title": "Software Developer",
  ...
  de: {
    ...
    "experience.selfEmployed.title": "Software Entwickler",
